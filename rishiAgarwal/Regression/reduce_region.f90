...
open(1,file='combined_csv_status.csv',status='old',action='read')
open(2,file='region_26.13_26.17_-10.55_-10.59.csv',status='unknown',action='write')
...
if( (min_lon .ge. 26.1324982) .and. (max_lon .le. 26.1725983) .and. (min_lat .ge. -10.5971392) &
.and. (max_lat .le. -10.5569179)  ) then
