...
class GEE_Mine(object):
    ...
    def __init__(self,system = 'Cluster', username='nason.e', jobname='routine', wd='/scratch/nason.e/', outputdir='outputs', \
                resultsdir='results', jobdir='batch', compiledfilename='compiled', assetid = 'users/EmilyNason/FinalResults', \
                featgeedescription='compiled_results', makefeaturecollection='False', conda_env_name='newEnv'):
        self.system = system
